...
const textInputVariants = cva(
  'flex h-9 w-full rounded-md border border-input bg-white px-3 py-1 text-sm shadow-sm transition-colors file:border-0 file:bg-white file:text-sm file:font-medium placeholder:font-normal placeholder:text-light-grey focus:border focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-300 disabled:cursor-not-allowed',
  {
    variants: {
      error: {
